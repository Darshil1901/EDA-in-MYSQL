...
SELECT
	job_title
FROM staff
WHERE job_title LIKE '%Assistant%III'
...
SELECT job_title
FROM staff
WHERE job_title LIKE '%E' or job_title LIKE '%P' or job_title LIKE '%S' ;
...
SELECT 
    ...
    FLOOR(AVG(salary)) AS truncated_salary, 
    FORMAT(AVG(salary), 2) AS truncated_salary_2_decimal,
